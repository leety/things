...
from ..cms_toolbar import ThingsToolbar, get_admin_url, get_obj_from_request
...
class TestToolbarHelpers(ThingsTransactionTestCase):
    ...
    def test_get_obj_from_request(self):
        ...
        for url in [slug_url, pk_url, ]:
            ...
            thing = get_obj_from_request(Thing, request)
            self.assertTrue(thing.pk, self.thing1.pk)
